...
// Composition Pattern | quanto temos um componente com varios elementos, podemos quebrar em varios componentes menores e juntar-os em um novo componente maior
